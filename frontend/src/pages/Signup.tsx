...
import { UserPlus, Mail, Lock, AlertCircle, Sparkles, CheckCircle } from 'lucide-react';
...
export function Signup() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (result.error) {
      ...
      // Try to sign in immediately (Supabase might allow this if email verification is disabled)
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Get started with InVideo Studio</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-slate-900/50 border border-slate-800 rounded-xl">
          <h3 className="text-sm font-medium text-white mb-2">Free Tier Includes:</h3>
          <ul className="text-sm text-slate-400 space-y-1">
            <li>• 15 script generations</li>
            <li>• 10 image generations/edits</li>
